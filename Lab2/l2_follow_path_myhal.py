...
PATH_NAME = 'MYHAL_shortest_path_rrt_CZ.npy'  # saved path from l2_planning.py, should be in the same directory as this file
...
class PathFollower():
    def __init__(self):
        ...
        self.path_tuples = np.load(os.path.join(cur_dir, 'shortest_path_rrt_CZ.npy')).T
